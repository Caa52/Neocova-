...
def predict():
    ...
    if form.validate_on_submit():
        ...
        db.session.commit()
        return render_template('predict_3.html', title='Login', form=form, prediction_text='Your bank evaluation is estimated as $ {}'.format(output))

    return render_template('predict_3.html',title='Login', form=form)
