...
class PredictForm(FlaskForm):
    ...
    s_roeinjr = SelectField(choices = ["+","-"])
    s_noijy = SelectField(choices = ["+","-"])
    s_asset = SelectField(choices = ["+","-"])
    s_RBCT1J = SelectField(choices = ["+","-"])
    s_core_deposit = SelectField(choices = ["+","-"])
    s_lnlsntv = SelectField(choices = ["+","-"])
    s_County_GDP_Percent = SelectField(choices = ["+","-"])
    s_PC_Labor_Force = SelectField(choices = ["+","-"])
    s_PC_Unemployed = SelectField(choices = ["+","-"])
    s_GR_Total_Population = SelectField(choices = ["+","-"])
    s_market_cap_5 = SelectField(choices = ["+","-"])

    roeinjr =  FloatField('Retained earnings to average equity (ytd only)',validators=[DataRequired(message=u"Please input percentage change"), NumberRange(min=0, max=1, message=u"Number is requred")])
    noijy =  FloatField('Net operating income to assets',validators=[DataRequired(message=u"Please input percentage change"), NumberRange(min=0, max=1, message=u"Number is requred")])
    asset =  FloatField('Total assets',validators=[DataRequired(message=u"Please input percentage change"), NumberRange(min=0, max=1, message=u"Number is requred")])
    RBCT1J =  FloatField('Tier one (core) capital',validators=[DataRequired(message=u"Please input percentage change"), NumberRange(min=0, max=1, message=u"Number is requred")])
    core_deposit =  FloatField('Core deposit',validators=[DataRequired(message=u"Please input percentage change"), NumberRange(min=0, max=1, message=u"Number is requred")])
    lnlsntv =  FloatField('Net loans and leases to total assets',validators=[DataRequired(message=u"Please input percentage change"), NumberRange(min=0, max=1, message=u"Number is requred")])
    County_GDP_Percent =  FloatField('County GDP Percent',validators=[DataRequired(message=u"Please input percentage change"), NumberRange(min=0, max=1, message=u"Number is requred")])
    PC_Labor_Force =  FloatField('Labor Force Percent',validators=[DataRequired(message=u"Please input percentage change"), NumberRange(min=0, max=1, message=u"Number is requred")])
    PC_Unemployed =  FloatField('Unemployed Percent',validators=[DataRequired(message=u"Please input percentage change"), NumberRange(min=0, max=1, message=u"Number is requred")])
    GR_Total_Population =  FloatField('GR Total Population',validators=[DataRequired(message=u"Please input percentage change"), NumberRange(min=0, max=1, message=u"Number is requred")])
    market_cap_5 =  FloatField('market_cap_5',validators=[DataRequired(message=u"Please input percentage change"), NumberRange(min=0, max=1, message=u"Number is requred")])
